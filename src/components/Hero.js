...
const Hero = ({ children }) => {
  ...
  return (
    <section className="hero" id="hero" style={{ position: 'relative', overflow: 'hidden' }}>
      {children}
      {/* Sine wave background spanning full hero width */}
      <div style={{
        position: 'absolute',
        top: '80%',
        left: '50%',
...
An AI voice assistant that works across chat, voice, and messaging—24/7. <br/>
A voice for your business, even when you’re off the clock.          </p>

          <div className="cta-buttons">
            <button className="link-button" onClick={(e) => handleSmoothScroll(e, '#howitworks')}>
